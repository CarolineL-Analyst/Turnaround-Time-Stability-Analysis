...
For each **Part Number + Workscope** combination, the analysis compares project-level TRT in each reporting period against that combination's own recent history, using rolling statistics.
...
Project lifecycle data is sourced from the operational project management system, including project creation and completion timestamps, along with associated **Part Number** and **Workscope** attributes.

> Field names shown in this repository have been generalized from the original system. The analytical approach reflects the version used in actual operational reviews.
...
- **Workscope** – the type of work performed (e.g., inspection, repair, overhaul)
